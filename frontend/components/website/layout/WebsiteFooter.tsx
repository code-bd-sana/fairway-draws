      ...
      <div className='container-custom'>
          ...
          <div className='lg:col-span-2 flex flex-col gap-5'>
            <Link href='/' className='flex items-center select-none group py-0.5'>
              <Image
                ...
                width={150}
                priority
                className='object-contain transition-transform duration-200 group-hover:scale-105 drop-shadow-md mix-blend-multiply contrast-105'
              />
            </Link>

            <p className='font-sans text-xs text-text-muted leading-relaxed max-w-sm'>
              The premier marketplace for charity gear prize competitions. Win top-tier replicas,
              tactical loadouts, and cash prizes from just £1. Transparent escrow payouts for secure
              hosting.
            </p>
        ...
        <div className='border-t border-divider pt-8 flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-6 text-[10px] text-text-muted leading-relaxed'>
          <div className='max-w-3xl'>
            <p className='mb-2'>
              © {new Date().getFullYear()} {BRAND_NAME}. All rights reserved. Registered in England
              & Wales.
            </p>
            <p>
              Prize draws are operated in accordance with the UK Gambling Act 2005 as compliant
              prize competitions. Participation is limited to individuals aged 18 or older resident
              in eligible jurisdictions. Ticket purchases are final and escrowed securely.
            </p>
          </div>
