      ...
      >
        <div className='container-custom flex items-center justify-between'>
          ...
          <Link href='/' className='flex items-center gap-2 select-none group py-0.5'>
            <div className='flex flex-col items-start leading-none group-hover:scale-105 transition-transform duration-200'>
              <span className='font-serif text-xl sm:text-2xl font-bold tracking-wider text-[#0b4d35] drop-shadow-sm'>
                FAIRWAY
              </span>
              <span className='font-sans text-[10px] sm:text-xs font-black tracking-widest text-[#dc2626] uppercase'>
                - DRAWS -
              </span>
            </div>
          </Link>
