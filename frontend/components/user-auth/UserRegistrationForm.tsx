        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col w-full gap-1.5">
            <label
              ...
              className="font-sans font-medium text-xs md:text-sm text-text-primary"
            >
              Phone Number <span className="text-text-muted/40 text-[10px] md:text-xs font-normal">(Optional)</span>
            </label>
            <input
              type="tel"
              id="phone"
          ...
          <div className="flex flex-col gap-3 mt-1">
            ...
            <label className="flex items-start gap-2.5 text-xs md:text-sm text-text-secondary select-none cursor-pointer">
              ...
              />
              <span className="leading-tight">
                I want to receive marketing updates, raffle announcements, and exclusive discount codes.
              </span>
            </label>
          </div>
