...
export const entrantSteps: HowItWorksStep[] = [
  ...
  },
  {
    ...
    description: "Explore the competitions. Filter by your favourite host, category, price, or closing time to find the draw that's right for you.",
  },
  {
    id: "entrant-step-3",
    stepNumber: 3,
    title: "Select Your Tickets",
    description: "Choose your quantity, use quick-select buttons for 5, 10, or 25 tickets.",
  },
  {
    id: "entrant-step-4",
    stepNumber: 4,
    title: "Complete Secure Payment",
    description: "Pay safely via Visa, Mastercard. All payments are encrypted and processed through our 3DS payment platform.",
  },
  {
    id: "entrant-step-5",
    stepNumber: 5,
...
export const hostSteps: HowItWorksStep[] = [
  ...
  },
  {
    ...
    description: "Fill in the draw details: prize, ticket price, total tickets, closing date. Our team reviews within 24h.",
  },
  {
    id: "host-step-5",
    stepNumber: 5,
    title: "Go Live on the Public Board",
    description: "Once approved, your draw is published to the competition board and visible to all users immediately. Then you can promote this on our own social medias/website.",
  },
  {
    id: "host-step-6",
    stepNumber: 6,
