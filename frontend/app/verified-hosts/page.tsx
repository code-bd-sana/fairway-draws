        ...
        <div className="container-custom">
          <div className="max-w-[800px] mb-12 flex flex-col gap-3">
            ...
            <p className="font-sans text-[14px] md:text-[16px] text-[#72943A] leading-relaxed max-w-[600px]">
              Explore our directory of fully vetted partners. Every host on Fairway Draws undergoes rigorous background and business checks to ensure your competitions are secure, fair, and legally compliant.
            </p>
          </div>
