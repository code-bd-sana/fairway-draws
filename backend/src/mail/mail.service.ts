        ...
        await this.transporter.sendMail({
          ...
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background-color: #111210; color: #E8EDD4; border-radius: 12px; border: 1px solid #2D3C13;">
              <h2 style="color: #0b4d35; margin-top: 0;">New Contact Inquiry — Fairway Draws</h2>
              <hr style="border: 0; border-top: 1px solid #E2EADF; margin: 16px 0;" />
              <p style="margin: 6px 0;"><strong>Name:</strong> ${dto.name}</p>
              <p style="margin: 6px 0;"><strong>Email:</strong> <a href="mailto:${dto.email}" style="color: #0b4d35;">${dto.email}</a></p>
              ...
              <div style="background-color: #ECF5EE; padding: 16px; border-radius: 8px; border-left: 4px solid #0b4d35; margin-top: 16px;">
                <h4 style="margin: 0 0 8px 0; color: #0b4d35;">Message:</h4>
                <p style="margin: 0; white-space: pre-wrap; color: #334e43; font-size: 14px; leading-height: 1.6;">${dto.message}</p>
              </div>
              <hr style="border: 0; border-top: 1px solid #E2EADF; margin: 24px 0 16px 0;" />
              <p style="font-size: 11px; color: #5e766c;">Fairway Draws Ltd • Sent via Fairway Draws Contact Form</p>
            </div>
          `,
        });
      ...
      await this.transporter.sendMail({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <h2>Welcome to Fairway Draws!</h2>
            <p>Please click the button below to verify your email address and activate your account:</p>
            <div style="text-align: center; margin: 30px 0;">
              <a href="${verificationUrl}" style="background-color: #0b4d35; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold;">Verify Email</a>
            </div>
